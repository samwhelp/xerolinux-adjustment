...
source "${THE_SUB_DIR_PATH}/pacman/ext/init.sh"
...
mod_main () {
	...
	${THE_SUB_PACMAN_BIN_DIR_PATH}/package-install.sh
	...
	${THE_SUB_PACMAN_BIN_DIR_PATH}/asset-install.sh
	...
	${THE_SUB_PACMAN_BIN_DIR_PATH}/config-install.sh
